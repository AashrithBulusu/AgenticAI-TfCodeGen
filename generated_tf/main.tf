...
module "azurestackhci_virtual_machine" {
  source = "Azure/avm-res-azurestackhci-virtualmachineinstance/azurerm"
  version = "2.0.0"
  admin_password = var.azurestackhci_virtual_machine_config.admin_password
  admin_username = var.azurestackhci_virtual_machine_config.admin_username
  auto_upgrade_minor_version = var.azurestackhci_virtual_machine_config.auto_upgrade_minor_version
  custom_location_id = var.azurestackhci_virtual_machine_config.custom_location_id
  data_disk_params = var.azurestackhci_virtual_machine_config.data_disk_params
  domain_join_extension_tags = var.azurestackhci_virtual_machine_config.domain_join_extension_tags
  domain_join_password = var.azurestackhci_virtual_machine_config.domain_join_password
  domain_join_user_name = var.azurestackhci_virtual_machine_config.domain_join_user_name
  domain_target_ou = var.azurestackhci_virtual_machine_config.domain_target_ou
  domain_to_join = var.azurestackhci_virtual_machine_config.domain_to_join
  dynamic_memory = var.azurestackhci_virtual_machine_config.dynamic_memory
  dynamic_memory_buffer = var.azurestackhci_virtual_machine_config.dynamic_memory_buffer
  dynamic_memory_max = var.azurestackhci_virtual_machine_config.dynamic_memory_max
  dynamic_memory_min = var.azurestackhci_virtual_machine_config.dynamic_memory_min
  enable_telemetry = var.azurestackhci_virtual_machine_config.enable_telemetry
  http_proxy = var.azurestackhci_virtual_machine_config.http_proxy
  https_proxy = var.azurestackhci_virtual_machine_config.https_proxy
  image_id = var.azurestackhci_virtual_machine_config.image_id
  linux_ssh_config = var.azurestackhci_virtual_machine_config.linux_ssh_config
  location = var.azurestackhci_virtual_machine_config.location
  lock = var.azurestackhci_virtual_machine_config.lock
  logical_network_id = var.azurestackhci_virtual_machine_config.logical_network_id
  managed_identities = var.azurestackhci_virtual_machine_config.managed_identities
  memory_mb = var.azurestackhci_virtual_machine_config.memory_mb
  name = var.azurestackhci_virtual_machine_config.name
  nic_tags = var.azurestackhci_virtual_machine_config.nic_tags
  no_proxy = var.azurestackhci_virtual_machine_config.no_proxy
  os_type = var.azurestackhci_virtual_machine_config.os_type
  private_ip_address = var.azurestackhci_virtual_machine_config.private_ip_address
  resource_group_name = var.azurestackhci_virtual_machine_config.resource_group_name
  role_assignments = var.azurestackhci_virtual_machine_config.role_assignments
  secure_boot_enabled = var.azurestackhci_virtual_machine_config.secure_boot_enabled
  tags = var.azurestackhci_virtual_machine_config.tags
  trusted_ca = var.azurestackhci_virtual_machine_config.trusted_ca
  type_handler_version = var.azurestackhci_virtual_machine_config.type_handler_version
  user_storage_id = var.azurestackhci_virtual_machine_config.user_storage_id
  v_cpu_count = var.azurestackhci_virtual_machine_config.v_cpu_count
  windows_ssh_config = var.azurestackhci_virtual_machine_config.windows_ssh_config
}
...
module "storage_account" {
  ...
  access_tier                          = var.storage_account_config.account_kind == "BlockBlobStorage" && var.storage_account_config.account_tier == "Premium" ? null : var.storage_account_config.access_tier
  ...
  local_user                           = var.storage_account_config.local_user
